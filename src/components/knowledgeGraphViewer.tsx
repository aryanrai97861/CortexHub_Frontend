...
const KnowledgeGraphViewer: React.FC<KnowledgeGraphViewerProps> = ({ workspaceId, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-90 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl h-3/4 flex flex-col p-6">
        <div className="flex justify-between items-center border-b border-gray-700 pb-4 mb-4">
          <h3 className="text-xl font-bold text-gray-200">Dynamic Knowledge Graph</h3>
