...
const Footer = () => {
  return (
    <footer className='bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 text-white border-t border-blue-800/30'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div className='md:col-span-2'>
            ...
            <p className='text-blue-100 mb-6 max-w-md'>
              The intelligent workspace that thinks with you. Powered by cutting-edge AI technology for seamless collaboration and productivity.
            </p>
            <div className='flex space-x-4'>
              <a href='#' className='w-10 h-10 bg-blue-600/20 hover:bg-blue-600/40 rounded-full flex items-center justify-center transition-colors duration-200'>
          ...
          <div>
            ...
            <ul className='space-y-2'>
              ...
              <li><a href='#' className='text-blue-100 hover:text-white transition-colors duration-200'>Status</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className='border-t border-blue-800/30 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center'>
          ...
          <div className='flex space-x-6 mt-4 md:mt-0'>
            <a href='#' className='text-sm text-blue-200 hover:text-white transition-colors duration-200'>Privacy Policy</a>
            <a href='#' className='text-sm text-blue-200 hover:text-white transition-colors duration-200'>Terms of Service</a>
            <a href='#' className='text-sm text-blue-200 hover:text-white transition-colors duration-200'>Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
